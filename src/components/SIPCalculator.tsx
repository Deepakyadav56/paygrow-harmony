...
const SIPCalculator: React.FC<SIPCalculatorProps> = ({ onboardingComplete }) => {
  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
      <Card className="p-6 rounded-xl shadow-md border border-fountain-blue-100">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Slider
                  ...
                  className="[&>span[data-orientation=horizontal]]:bg-fountain-blue-200 [&>span[data-orientation=horizontal]>span]:bg-fountain-blue-500"
                />
              </div>
          ...
          <TabsContent value="details" className="mt-4">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-fountain-blue-600 font-semibold">₹{maturityValue.toLocaleString()}</span>
              </div>
            </div>
          </TabsContent>
        </Tabs>
        ...
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" className="rounded-full border-fountain-blue-300 text-fountain-blue-600 hover:bg-fountain-blue-50">
