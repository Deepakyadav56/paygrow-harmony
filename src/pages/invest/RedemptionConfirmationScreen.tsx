  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-fountain-blue-50 to-white">
      ...
      <div className="p-4 pb-24">
        ...
        >
          <div className="w-20 h-20 bg-fountain-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 animate-bounce-soft">
          ...
          <Card className="p-5 shadow-md rounded-xl border-0 mb-6 hoverable-card">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-fountain-blue-600">₹16,270</span>
              </div>
        ...
        >
          <Card className="p-5 mb-6 border border-fountain-blue-100 bg-fountain-blue-50/50 rounded-xl">
              ...
              {stages.map((stage, index) => (
                <div key={index} className="flex items-start">
                  <div className="mr-3 relative">
                    <div className={`h-6 w-6 rounded-full ${stage.completed ? 'bg-fountain-blue-100' : 'bg-gray-100'} flex items-center justify-center`}>
                      {stage.completed ? (
                    ...
                    {index < stages.length - 1 && (
                      <div className={`absolute top-6 left-1/2 w-px h-10 transform -translate-x-1/2 ${stage.completed && stages[index + 1].completed ? 'bg-fountain-blue-500' : 'bg-gray-200'}`} />
                    )}
                  </div>
        ...
        >
          <Button 
            className="w-full bg-gradient-to-r from-fountain-blue-500 to-fountain-blue-600 text-white gap-1 h-12 shadow-md"
        ...
        <div className="mt-6 flex justify-center">
          <motion.div 
            ...
            className="flex items-center text-sm text-fountain-blue-600 cursor-pointer" 
            onClick={() => {
              toast({
                title: "Support",
