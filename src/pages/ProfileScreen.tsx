...
const ProfileScreen: React.FC = () => {
  ...
  return (
    <div className="pb-20 bg-gray-50 dark:bg-gray-900 min-h-screen"> 
      {/* Header */}
      <div className="bg-gradient-to-r from-fountain-blue-600 to-fountain-blue-700 text-white pt-14 pb-8 px-5 rounded-b-3xl shadow-lg">
        ...
        <Card className="bg-white/10 backdrop-blur-sm border-none text-white p-5 rounded-2xl">
          <div className="flex items-start">
            <Avatar className="h-16 w-16 border-2 border-white/30">
              ...
              <AvatarFallback className="bg-fountain-blue-500">RS</AvatarFallback>
            </Avatar>
              ...
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-xl font-semibold flex items-center">
                    Rahul Sharma 
                    <Badge className="ml-2 bg-fountain-blue-400/50 hover:bg-fountain-blue-400/70 text-white text-xs py-1">Premium</Badge>
                  </h2>
      ...
      <div className="px-5 -mt-5">
        <Card className="grid grid-cols-3 divide-x divide-gray-100 shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-800 dark:divide-gray-700">
          <div className="flex flex-col items-center justify-center">
            <span className="text-lg font-bold text-fountain-blue-600">₹48,550</span>
      ...
      <div className="px-5 mt-6 space-y-6">
        ...
        <div>
          ...
          <Card className="divide-y divide-gray-100 rounded-2xl overflow-hidden dark:divide-gray-700 dark:bg-gray-800">
            <Link to="/settings" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-fountain-blue-100 dark:bg-fountain-blue-900/50 flex items-center justify-center mr-3">
                  <Settings className="w-5 h-5 text-fountain-blue-600" />
                </div>
            ...
            <Link to="/notifications" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
            ...
            <Link to="/payment-methods" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
            ...
            <Link to="/theme" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
        ...
        <div>
          ...
          <Card className="divide-y divide-gray-100 rounded-2xl overflow-hidden dark:divide-gray-700 dark:bg-gray-800">
            <Link to="/transaction-history" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center mr-3">
            ...
            <Link to="/portfolio" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-fountain-blue-100 dark:bg-fountain-blue-900/50 flex items-center justify-center mr-3">
                  <BarChart3 className="w-5 h-5 text-fountain-blue-500" />
                </div>
            ...
            <Link to="/rewards" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
            ...
            <Link to="/tax-reports" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center mr-3">
        ...
        <div>
          ...
          <Card className="divide-y divide-gray-100 rounded-2xl overflow-hidden dark:divide-gray-700 dark:bg-gray-800">
            <Link to="/profile/kyc" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center mr-3">
            ...
            <Link to="/security" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
            ...
            <Link to="/help" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center mr-3">
            ...
            <Link to="/chat" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-fountain-blue-100 dark:bg-fountain-blue-900/50 flex items-center justify-center mr-3">
                  <MessageSquare className="w-5 h-5 text-fountain-blue-500" />
                </div>
                <div className="flex items-center">
            ...
            <button 
              ...
              className="flex items-center justify-between p-4 w-full text-left hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors"
            >
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-red-100 dark:bg-red-900/50 flex items-center justify-center mr-3">
        ...
        <div>
          ...
          <Card className="divide-y divide-gray-100 rounded-2xl overflow-hidden dark:divide-gray-700 dark:bg-gray-800">
            <Link to="/rate-app" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
            ...
            <Link to="/refer" className="flex items-center justify-between p-4 hover:bg-fountain-blue-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center mr-3">
                ...
                <div className="flex items-center">
                  ...
                  <Badge className="bg-fountain-blue-500">₹100 Bonus</Badge>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 text-gray-400" />
            </Link>
