    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white flex flex-col justify-center">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 text-sm mt-2">Start your investment journey today</p>
        </div>
        ...
        <div className="mt-8 text-center px-6">
          ...
          <p className="text-xs text-gray-500 mt-4">By signing up, you agree to our Terms & Conditions and Privacy Policy</p>
        </div>
      </motion.div>
    </div>
  );
