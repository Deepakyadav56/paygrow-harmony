    ...
    <div className="min-h-screen bg-gradient-to-b from-background/80 to-background flex flex-col justify-center">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">TimePay</h1>
          <p className="text-gray-600 dark:text-gray-300 text-sm mt-2">India's Trusted Investment Platform</p>
        </div>
        <AuthForm mode="login" />
